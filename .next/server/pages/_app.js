;(function () {
  ...
  \*************************/
      /***/ function (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ API_URL: function () {
            return /* binding */ API_URL
          },
          /* harmony export */ NEXT_URL: function () {
            return /* binding */ NEXT_URL
          },
          /* harmony export */ PER_PAGE: function () {
            return /* binding */ PER_PAGE
          },
          /* harmony export */
        })
  ...
  \********************************/
      /***/ function (
        ...
        /* harmony import */ var _config_index__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ../config/index */ './config/index.js')

        var _jsxFileName =
          'C:\\Users\\koran\\Desktop\\dj-events\\dj-events-frontend\\context\\AuthContext.js'
        ...
        const AuthProvider = ({ children }) => {
          ...
          const router = (0,
          next_router__WEBPACK_IMPORTED_MODULE_2__.useRouter)() // Register user

          const register = async (user) => {
            const res = await fetch(
              `${_config_index__WEBPACK_IMPORTED_MODULE_3__.NEXT_URL}/api/register`,
              {
                method: 'POST',
                headers: {
          ...
          const login = async ({ email: identifier, password }) => {
            const res = await fetch(
              `${_config_index__WEBPACK_IMPORTED_MODULE_3__.NEXT_URL}/api/login`,
              {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json',
          ...
          const logout = async () => {
            const res = await fetch(
              `${_config_index__WEBPACK_IMPORTED_MODULE_3__.NEXT_URL}/api/logout`,
              {
                method: 'POST',
              }
            )
          ...
          const checkUserLoggedIn = async (user) => {
            const res = await fetch(
              `${_config_index__WEBPACK_IMPORTED_MODULE_3__.NEXT_URL}/api/user`
            )
            const data = await res.json()
  ...
  \***********************/
      /***/ function (
        ...
        /* harmony import */ var _context_AuthContext__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! @/context/AuthContext */ './context/AuthContext.js'
          )
        ...
        var _jsxFileName =
          'C:\\Users\\koran\\Desktop\\dj-events\\dj-events-frontend\\pages\\_app.js'
        ...
        function MyApp({ Component, pageProps }) {
          return /*#__PURE__*/ (0,
          react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(
            _context_AuthContext__WEBPACK_IMPORTED_MODULE_1__.AuthProvider,
            {
              children: /*#__PURE__*/ (0,
              react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(
                Component,
